...
In this package, the desired trajectory of the flying robots is [4,9,1.5] along the x, y, and z-axis respectively. Therefore, we choose four obstacles inside the working spaces that are listed as follows:
