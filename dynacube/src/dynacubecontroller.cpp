...
double kpx = 0.105, kdx = 0.125, kpy = 0.075, kdy = 0.105;
...
public:
    ...
    void stateCallback(const gazebo_msgs::ModelStates::ConstPtr& msg) {
        try {
            ...
            outfilev.open("dev_ws/src/dynacube/data/velodynacube.txt", std::ios_base::app); // Append mode
            ...
            outfilex.open("dev_ws/src/dynacube/data/positiondynacube.txt", std::ios_base::app); // Append mode
            outfilex << "Time: " << current_time.toSec() << ", x: " << rx << ", y: " << ry << ", z: " << rz << ", phi: " << rphi << ", theta: " << rtheta << ", psi: " << rpsi << "\n";
            outfilex.close();

            std::ofstream outfileu;
            outfileu.open("dev_ws/src/dynacube/data/controldynacube.txt", std::ios_base::app); // Append mode
