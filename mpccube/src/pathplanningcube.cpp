...
public:
    ...
    void stateCallback(const gazebo_msgs::ModelStates::ConstPtr& msg) {
        try {
            ...
            MX ob1 = abs(X(0,all) + 0.423) + abs(X(0,all) + 2.723) + abs(X(1,all) - 1) + abs(X(1,all) - 3.6) + abs(X(2,all) + 0.25) + abs(X(2,all) - 2.05); 
            MX ob2 = abs(X(0,all) + 0.24) + abs(X(0,all) + 2.74) + abs(X(1,all) - 3.97) + abs(X(1,all) - 6.57) + abs(X(2,all) + 0.25) + abs(X(2,all) - 1.75);
            MX ob3 = abs(X(0,all) - 0.28) + abs(X(0,all) - 2.88) + abs(X(1,all) - 3.2) + abs(X(1,all) - 5.6) + abs(X(2,all) + 0.25) + abs(X(2,all) - 2.05);
            MX ob4 = abs(X(0,all) - 2) + abs(X(0,all) - 6.4) + abs(X(1,all) + 0.05) + abs(X(1,all) - 1.25) + abs(X(2,all) + 0.25) + abs(X(2,all) - 2.85); 
            ...
            opti.subject_to(7.2 <= ob1);
            opti.subject_to(7.2 <= ob2);
            opti.subject_to(7.3 <= ob3);
            opti.subject_to(8.8 <= ob4);
            Dict ipopt_options;
